                ...
                <form method="POST" action="{{ route('mypage.edit-profile') }}" class="p-5" enctype="multipart/form-data">
                    ...
                    <span class="avatar-form image-picker">
                        ...
                        @if (!empty($user->avatar_file_name))
                            <img src="{{ route('top')}}/storage/avatars/{{$user->avatar_file_name}}" class="rounded-circle" style="object-fit: cover; width: 200px; height: 200px;">
                        @else
                            <img src="{{ route('top')}}/images/avatar-default.svg" class="rounded-circle" style="object-fit: cover; width: 200px; height: 200px;">
                        @endif
                        </label>
                    </span>
