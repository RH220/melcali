            ...
            <div class="col-10 offset-1 bg-white">
                ...
                @foreach ($items as $item)
                    <div class="d-flex mt-3 border position-relative">
                        <div>
                            <img src="{{ route('top')}}/storage/item-images/{{$item->image_file_name}}" class="img-fluid" style="height: 140px;">
                        </div>
                        <div class="flex-fill p-3">
                            <div>
                            <!-- 「出品中」「売却済」ラベルを出力しています。 -->
                            <!-- isStateSellingはEloquent Modelのアクセサという仕組みで実装されており、「商品の状態」が「出品中」なら真になります。 -->
